	...
	return (
		<Fragment>
			<div className="workingWith">
				...
				<div id="aboutExamples" className={css.workWith}>
					...
					<div><a href="http://www.google.com/search?q=Spring+Boot" target="_blank" rel="noopener noreferrer"><img src={springBoot} alt="Spring Boot" /></a></div>
