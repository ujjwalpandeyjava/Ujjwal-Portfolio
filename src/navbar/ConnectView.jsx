...
import { email, copyEmailToClipboard } from "../assets/Utilities";
	...
	return (
		<div id={style.connectMain}>
			...
			<div className={style.contactEmail}>
				<div className={style.emptyTop}></div>
				<div className={style.e_mailContainer} onDoubleClick={copyEmailToClipboard}>
					<div className={style.e_mail}>{email}</div>
				</div>
