...
const skillsData = [
	...
	// --- Mobile app ---
	{ type: "Mobile", title: "React Native", icon: <FaReact />, desc: "I have experience in building cross-platform mobile applications using React Native." },
	{ type: "Mobile", title: "Expo", icon: <SiExpo />, desc: "I have experience in building cross-platform mobile applications using Expo." },
	...
	{ type: "Frontend", title: "Angular", icon: <FaAngular />, desc: "I have experience in building dynamic web applications using Angular." },
	...
	{ type: "Others", title: "JSON", icon: <BiSolidFileJson />, desc: "Use JSON for data interchange between the client and server." },
	{ type: "Others", title: "SOAP", icon: <SiXml />, desc: "Experience with SOAP web services for building and consuming enterprise-level APIs." },
	{ type: "Others", title: "Agile Methods", icon: <FaTasks />, desc: "I follow Agile practices like Scrum and Kanban to ensure iterative development and fast delivery cycles." },
